...
LATEST_RULES = {
    ...
    "www.ixs.cc": PLAN_01,
    "www.pinshu.cc": PLAN_01,
    "00xs.com": PLAN_01,
    "www.mmmli.com": PLAN_01,
...
RULES = {
    ...
    'www.pinshu.cc': Rules('0', {'id': 'list'}, {'id': 'content'}),
    '00xs.com': Rules('0', {'id': 'readerlist'}, {'id': 'content'}),
    'www.mmmli.com': Rules('0', {'class': 'novel'}, {'class': 'content'}),
    'www.bequge.net': Rules('0', {'id': 'list-chapterAll'}, {'id': 'htmlContent'}),
    ...
    # 已解析
    'www.biquge.com': Rules('http://www.biquge.com/', {'id': 'list'}, {'id': 'content'}),
    # 已解析
