...
if os.path.exists('./files/config.json'):
    with open('./files/config.json', encoding='utf8') as rf:
        CONFIG = json.loads(rf.read())

# DOMAIN
DEFAULT_BLACK_DOMAIN = ['www.17k.com', 'mm.17k.com', 'www.xs8.cn', 'www.zongheng.com', 'yunqi.qq.com',
                        'chuangshi.qq.com',
                        ...
                        "xs.sogou.com", "www.pinshu.cc", "00xs.com", "www.mmmli.com", "www.qiuyulu.com",
                        "www.leixuesong.cn"]

BLACK_DOMAIN = CONFIG.get('BLACK_DOMAIN', DEFAULT_BLACK_DOMAIN)
...
REPLACE_RULES = CONFIG.get('REPLACE_RULES', DEFAULT_REPLACE_RULES)

# 搜索引擎检索优先级
DEFAULT_ENGINE_PRIORITY = ['so', 'baidu']
ENGINE_PRIORITY = CONFIG.get('ENGINE_PRIORITY', DEFAULT_ENGINE_PRIORITY)

DEFAULT_REPLACE_HTML_STRING = ['&nbsp;']
REPLACE_HTML_STRING = CONFIG.get('REPLACE_HTML_STRING', DEFAULT_REPLACE_HTML_STRING)

DEFAULT_CHAPTER_TAG = ['a']
CHAPTER_TAG = CONFIG.get('CHAPTER_TAG', DEFAULT_CHAPTER_TAG)

DEFAULT_CONTENT_REPLACE = {
    '\u3000': '\n',
    '\xa0': '\n',
    '加入书签': '',
    '上一章': '',
...
CONTENT_REPLACE = CONFIG.get('CONTENT_REPLACE', DEFAULT_CONTENT_REPLACE)
...
DEFAULT_RULES = {
    ...
    # 'www.biqugexs.com': Rules('0', {'id': 'list'}, {'id': 'content'}),
